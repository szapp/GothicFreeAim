...
const int oCAniCtrl_Human__Turn                   = 0; //0x6AE540
const int oCNpc__TurnToEnemy_737D75               = 0; //0x737D75
...
const int oCGame__s_bUseOldControls               = 0; //0x8B21C0
const int mouseEnabled                            = 0; //0x8D1D6C
const int projectileDeflectOffNpcAddr             = 0; //0x6A0B66
const int oCAIHuman__BowMode_695F2B               = 0; //0x695F2B
const int oCAIHuman__BowMode_6962F2               = 0; //0x6962F2
const int oCAIHuman__PC_ActionMove_69A0BB         = 0; //0x69A0BB
const int oCAIHuman__PC_Strafe                    = 0; //0x69AC80
const int zCWorld__AdvanceClock                   = 0; //0x6260E0 // Hook length 10
const int cGameManager__ApplySomeSettings_rtn     = 0; //0x429273 // Hook length 5
const int oCAIHuman__BowMode                      = 0; //0x695F00 // Hook length 6
const int oCAIHuman__BowMode_696296               = 0; //0x696296 // Hook length 5
const int oCAIHuman__BowMode_6962A4               = 0; //0x6962A4 // Hook length 6
const int oCAIHuman__BowMode_69633B               = 0; //0x69633B // Hook length 6
const int oCAIArrow__SetupAIVob                   = 0; //0x6A10E0 // Hook length 6
const int oCAIArrow__CanThisCollideWith           = 0; //0x6A1490 // Hook length 7
const int oCAIArrow__DoAI_6A1489                  = 0; //0x6A1489 // Hook length 6
const int oCAIArrowBase__DoAI_6A06D8              = 0; //0x6A06D8 // Hook length 6
...
const int oCSpell__Setup_484BA9                   = 0; //0x484BA9 // Hook length 6
const int mouseUpdate                             = 0; //0x4D40FB // Hook length 5
