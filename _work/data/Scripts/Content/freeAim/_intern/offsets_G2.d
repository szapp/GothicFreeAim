...
const int zString_CamModNormal                    = 0;       // Not needed for Gothic 2
const int zString_CamModMelee                     = 0;       // Not needed for Gothic 2
const int zString_CamModRun                       = 0;       // Not needed for Gothic 2
const int oCAIHuman__Cam_Normal                   = 0;       // Not needed for Gothic 2
const int oCAIHuman__Cam_Fight                    = 0;       // Not needed for Gothic 2
const int oCAniCtrl_Human__Turn                   = 7005504; //0x6AE540
const int oCNpc__TurnToEnemy_A5                   = 7568757; //0x737D75
...
const int ztimer                                  = 10073044;//0x99B3D4
...
const int oCAIHuman__BowMode_2B                   = 6905643; //0x695F2B
const int oCAIHuman__BowMode_3F2                  = 6906610; //0x6962F2
const int oCAIHuman__MagicMode_D0                 = 0;       // Not needed for Gothic 2
...
const int oCAIHuman__BowMode_43B                  = 6906683; //0x69633B // Hook length 6
...
const int oCAIArrow__DoAI_29                      = 6952073; //0x6A1489 // Hook length 6
const int oCAIArrowBase__DoAI_98                  = 6948568; //0x6A06D8 // Hook length 6
