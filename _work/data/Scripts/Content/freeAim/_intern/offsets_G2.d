...
const int oCAIArrowBase__ReportCollisionToAI_npc  = 6949734; //0x6A0B66
...
const int oCAIHuman__BowMode_postInterpolate      = 6906532; //0x6962A4 // Hook length 6
const int oCAIHuman__BowMode_shoot                = 6906683; //0x69633B // Hook length 6
...
const int oCAIArrow__DoAI_rtn                     = 6952073; //0x6A1489 // Hook length 6
const int oCAIArrowBase__DoAI_collision           = 6948568; //0x6A06D8 // Hook length 6
...
const int oCAIArrow__ReportCollisionToAI_hitChc   = 6953483; //0x6A1A0B // Hook length 5
const int oCAIArrow__ReportCollisionToAI_damage   = 6953711; //0x6A1AEF // Hook length 7
const int oCNpc__OnDamage_Hit_criticalHit         = 6718100; //0x668294 // Hook length 5   // Not used for Gothic 2
const int oCNpc__OnDamage_Anim_getModel           = 6774593; //0x675F41 // Hook length 9
